...
I installed [resolvconf](https://roy.marples.name/projects/openresolv), which is able to manage exactly this scenario and, boom!, it\'s fixed! I couldn\'t find an answer in Google, so I am posting my solution here, in case somebody has the same issue.
