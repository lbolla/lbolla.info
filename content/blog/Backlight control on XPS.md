...
The issue is that the `Fn` key to control screen brightness (using `F11` and `F12`) doesn\'t work and results in this error in the logs:
...
The error has been reported [many](https://bugs.freedesktop.org/show_bug.cgi?id=97883) [times](https://www.dell.com/community/Precision-Mobile-Workstations/ACPI-errors-with-new-bios-in-Dell-Precision-7540/td-p/7390895) in the last year.

The only thing that worked for me was using this: [icc-brightness](https://github.com/udifuchs/icc-brightness). It is basically a workaround the BIOS/Kernel issue, but it works very well.
