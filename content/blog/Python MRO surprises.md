...
To work it out you need to know about Python\'s MRO (Method Resolution Order): [this article](https://medium.com/@__hungrywolf/mro-in-python-3-e2bcd2bd6851) provides a clear explanation of how it works. In this case, we have:
