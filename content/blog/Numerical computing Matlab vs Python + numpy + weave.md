...
The tests are heavily inspired by [Prabhu Ramachandran](http://www.scipy.org/PerformancePython). I\'ve only added Matlab to complete his comparisons.

Here is a short description of the test, taken from [here](http://www.scipy.org/PerformancePython):
...
Pretty amazing, if you think that optimizing Python, most of the time, is really trivial. Moreover, Python is free and easily parallelizable with [MPI](http://mpi4py.scipy.org/) (I\'ll show some performances in a future post).
