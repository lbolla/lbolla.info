...
In this post, I\'ll describe 3 scripts to \"pretty print\" some common file types, to improve readability: [`csvfmt`](https://github.com/lbolla/cmd/blob/master/csvfmt), [`xmlfmt`](https://github.com/lbolla/cmd/blob/master/xmlfmt) and [`jsonfmt`](https://github.com/lbolla/cmd/blob/master/jsonfmt).

[`csvfmt`](https://github.com/lbolla/cmd/blob/master/csvfmt) takes a `CSV` (\"Comma Separated Values\") file from `stdin`, parses it and pretty print each record as a Python dictionary.
...
[`jsonfmt`](https://github.com/lbolla/cmd/blob/master/jsonfmt) takes a `JSON` file from `stdin` and pretty prints it as a Python object.
...
All three scripts are written in Python and available [here](https://github.com/lbolla/cmd).
