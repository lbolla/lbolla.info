...
First of all, download and install the [App Engine Go software development kit](https://developers.google.com/appengine/docs/go/gettingstarted/devenvironment). Then create the following directory structure:
